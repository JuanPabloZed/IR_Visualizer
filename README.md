IR Visualizer is a python-made WAV visualizer (mostly to be used with IR Maker) designed to analyse and compare up to 4 all-mono or all-stereo WAV files.
